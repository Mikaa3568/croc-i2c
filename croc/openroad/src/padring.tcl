...
place_pad -row IO_NORTH -location [expr {$northStart - 12*$northPitch}] "pad_i2c_sda_io"      ; # pin no: 13
place_pad -row IO_NORTH -location [expr {$northStart - 13*$northPitch}] "pad_i2c_scl_io"      ; # pin no: 14
