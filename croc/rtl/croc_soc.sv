...
module croc_soc import croc_pkg::*; #(
  ...
  input  logic i2c_sda_i,                    // I2C SDA input
  output logic i2c_sda_o,                    // I2C SDA output
  output logic i2c_sda_oe,                   // I2C SDA output enable
  input  logic i2c_scl_i,                    // I2C SCL input
  output logic i2c_scl_o,                    // I2C SCL output
  output logic i2c_scl_oe                    // I2C SCL output enable
);
