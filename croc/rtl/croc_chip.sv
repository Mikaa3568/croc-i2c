...
module croc_chip import croc_pkg::*; #() (
  ...
  inout wire VSSIO
    ...
    logic soc_i2c_sda_i;
    logic soc_i2c_sda_o;
    logic soc_i2c_sda_oe;
    logic soc_i2c_scl_i;
    logic soc_i2c_scl_o;
    logic soc_i2c_scl_oe;
    ...
    sg13g2_IOPadInOut30mA pad_i2c_sda_io   (.pad(i2c_sda_io), .c2p(soc_i2c_sda_o), .p2c(soc_i2c_sda_i), .c2p_en(soc_i2c_sda_oe));
    sg13g2_IOPadInOut30mA pad_i2c_scl_io   (.pad(i2c_scl_io), .c2p(soc_i2c_scl_o), .p2c(soc_i2c_scl_i), .c2p_en(soc_i2c_scl_oe));
